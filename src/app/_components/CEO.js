                        ...
                        <div className="flex flex-col sm:flex-row ">
                            <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                                ...
                                <div className="flex flex-col items-center text-center justify-center">
                                    ...
                                    <h2 className="font-medium title-font  text-gray-400 text-sm">CEO, HandyHelper</h2>
                            ...
                            justify-center ">
                                <p className="leading-relaxed text-base md:text-lg md:px-10 mb-4">&ldquo;I&apos;m Himanshu, a 21-year-old self-taught programmer and recent bachelor&apos;s graduate actively seeking job opportunities. Passionate about technology, I aim to revolutionize service finding with HandyHelper, connecting users to trusted professionals conveniently. Dedicated to leveraging innovation for positive impact, I eagerly anticipate contributing my skills and vision to shaping the future of service accessibility.&rdquo; </p>
