                ...
                <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-transparent mt-16 md:mt-10  antialiased">
                    ...
                    <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                        <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                                ...
                                <address className="flex items-center mb-6 not-italic">
                                    <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-black">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base text-gray-500 dark:text-gray-600">Web Developer, Gamer & CEO FindMyMate</p>
                            ...
                            <p className="lead">In today&apos;s fast-paced world, finding reliable professionals for household tasks like plumbing, electrical work, and painting can be a daunting challenge. Traditionally, it involved visiting multiple locations and making numerous calls, often leading to frustration and wasted time. That&apos;s where FindMyMate steps in, revolutionizing the way people connect with service professionals.</p>
                            <p>FindMyMate is a user-friendly platform designed to match users with skilled service professionals from various fields directly through their smartphones or computers. Instead of wandering through markets or relying on word-of-mouth, users simply visit FindMyMate&apos;s intuitive interface. By browsing through profiles of electricians, plumbers, painters, and more, users can assess each professional&apos;s qualifications and reviews, all conveniently displayed on profile cards.</p>
                            <figure><img className='my-3' src="https://flowbite.s3.amazonaws.com/typography-plugin/typography-image-1.png" alt="" />

                            </figure>
                            <h2 className='text-lg font-bold my-2'>Why Choose FindMyMate?</h2>
                            <p>The inspiration behind FindMyMate stems from the common frustration of searching for reliable service providers. Founder and CEO, Himanshu, a self-taught programmer at just 21 years old, understands this struggle firsthand. &ldquo;I saw a gap in the market where people needed a seamless way to find trustworthy professionals,&rdquo; he explains. &ldquo;FindMyMate bridges this gap by offering a curated pool of service providers verified with essential details like GSTIN, ensuring transparency and reliability.&rdquo;</p>
                            <p>For homeowners, FindMyMate offers peace of mind knowing that every service professional on the platform undergoes a rigorous verification process, including validation of their GSTIN (Goods and Services Tax Identification Number). This verification not only establishes credibility but also enhances security, protecting users from potential scams or subpar services.</p>
                            <h2 className='text-lg font-bold my-2'>For Service Providers</h2>
                            <p>FindMyMate isn&apos;t just for users—it&apos;s also a valuable tool for professionals looking to expand their client base. Whether you&apos;re an electrician, plumber, painter, carpenter, or any other service provider, creating an account on FindMyMate allows you to showcase your skills and expertise to a wide audience. The platform provides a dedicated space for professionals to highlight their qualifications, display customer testimonials, and even list specializations or certifications. This exposure helps service providers attract new clients who value quality, reliability, and professionalism.</p>
                            <ol>
                                <li>
                                    <br />
                                    ...
                                    <br />
                                    <br />
                                    FindMyMate boasts a diverse pool of professionals from various fields such as electricians, plumbers, painters, carpenters, and more. Each professional undergoes a rigorous verification process to ensure they meet our high standards of reliability and expertise. This extensive pool ensures that users can find the right professional for any home service need quickly and efficiently.
                                </li>
                                <li>
                                    <br />
                                ...
                                <li>
                                    ...
                                    <br />
                                    <br />
                                    Designed with simplicity and ease of use in mind, FindMyMate offers a user-friendly interface that simplifies the process of finding and hiring professionals. Intuitive navigation, clear information presentation on professional profiles, and straightforward booking options make it easy for users to accomplish their tasks with minimal effort and time.
                                </li>
                                <li>
                                    <br />
